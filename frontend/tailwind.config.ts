	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-quantum-subtle': 'var(--gradient-quantum-subtle)',
				'gradient-sphere': 'var(--gradient-sphere)'
			},
			boxShadow: {
				'quantum': 'var(--shadow-quantum)',
				'glow': 'var(--shadow-glow)',
				'quantum-card': 'var(--shadow-card)'
			},
			transitionTimingFunction: {
				'quantum': 'cubic-bezier(0.4, 0, 0.2, 1)',
				'sphere': 'cubic-bezier(0.34, 1.56, 0.64, 1)'
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			keyframes: {
				...
				'quantum-glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--quantum-primary) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--quantum-primary) / 0.6)'
					}
				},
				'fade-in-up': {
					'0%': {
